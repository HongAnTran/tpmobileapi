...
export class ProductAttributesController {
  ...
  @Post()
  create(@Body() createProductAttributeDto: Prisma.ProductAttributesCreateInput) {
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateProductAttributeDto:  Prisma.ProductAttributesUpdateInput) {
