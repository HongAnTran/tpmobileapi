...
COPY public."Article" (id, title, content, published, "authorId", category_id, slug, description, thumnal_url) FROM stdin;
...
SELECT pg_catalog.setval('public."Option_id_seq"', 70, true);
...
SELECT pg_catalog.setval('public."ProductSpecifications_id_seq"', 128, true);
...
SELECT pg_catalog.setval('public."ProductVariant_id_seq"', 228, true);
